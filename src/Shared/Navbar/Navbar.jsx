            ...
            <div className="navbar  bg-cyan-950 text-white max-w-screen-xl">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 items-center rounded-box w-52">
                            {navOptions}
                        </ul>
                    </div>
                    <img src={img} alt="" />
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu item menu-horizontal px-1">
                        {navOptions}
                    </ul>
                </div>
